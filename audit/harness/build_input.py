...
REGEX_NAMES = [
    ...
    "iTunes", "Dolby Digital", "Dolby Digital +", "German DL", "Full Disc", "x264", "Special Edition", "Paramount+", "Apple TV+", "CAM", "Movie DUBBED", "TV DUBBED", "Movie Extras", "TV Extras", "Repack1", "3D",
]
